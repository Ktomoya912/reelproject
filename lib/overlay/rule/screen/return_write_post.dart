...
class ReturnWritePost {
  factory ReturnWritePost() => _shared;
  static final ReturnWritePost _shared = ReturnWritePost._sharedInstance();
  ReturnWritePost._sharedInstance();
