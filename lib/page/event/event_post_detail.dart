                                                                            ...
                                                                            child:
                                                                              ...
                                                                              actions: <Widget>[
                                                                                TextButton(
                                                                                  child: const Text('投稿'),
                                                                                  onPressed: () {
                                                                                    reviewWrite(eventDetailList["id"], store);
                                                                                    Navigator.of(context).pop();
                                                                                    Navigator.of(context).pop();
                                                                                    showDialog(
                                                                                      context: context,
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    final TextEditingController
                                                                        ...
                                                                        TextEditingController(
                                                                            text:
                                                                                eventDetailList["review"][index]["title"]);
                                                                    final TextEditingController
                                                                        detailController =
                                                                        TextEditingController(
                                                                            text:
                                                                                eventDetailList["review"][index]["review"]);
                                                                    showDialog(
                                                                      context:
                                                                          context,
                                                                      builder:
                                                                        ...
                                                                        return Center(
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              // ),
                                                                              children: [
                                                                                if (eventDetailList["review"][index]["user"]["id"] == store.myID)
                                                                                  Center(
                                                                                    child: SizedBox(
                                                                                      width: width / 10 * 6,
                                                                                      child: const Text(
                                                                                ...
                                                                                SimpleDialogOption(
                                                                                  ...
                                                                                  child: const Text("不適切なレビューとして報告"),
                                                                                ),
                                                                                SimpleDialogOption(
                                                                                  onPressed: () => {
                                                                                    Navigator.pop(context),
