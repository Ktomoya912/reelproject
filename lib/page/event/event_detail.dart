...
class _EventDetailState extends State<EventDetail> {
  ...
  Widget generateWidgets(int i, double height) {
    if (i == 0) {
      return Text(eventDetailList["postalNumber"][i] +
          "〒" +
          "   " +
      ...
      if (eventDetailList["postalNumber"][i] +
        ...
        return Column(
          ...
          children: [
            ...
            Text(eventDetailList["postalNumber"][i] +
                "〒" +
                "   " +
                eventDetailList["prefecture"][i] +
                eventDetailList["city"][i] +
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: IconButton(
                          ...
                          icon: Icon(Icons.arrow_back, color: store.greyColor)),
                    ),
                  )
                ]),
                //タイトル
                      ...
                      child: Row(
                        ...
                        children: [
                          for (int i = 0;
                            ...
                            TextButton(
                                onPressed: () => {},
                                child: Text("#${eventDetailList["tag"][i]}")),
                        ],
                      ),
                    ),
                  ),
