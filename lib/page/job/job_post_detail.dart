...
class _JobPostDetailState extends State<JobPostDetail> {
  late bool notJobJedge = widget.notJobJedge;
  ...
  Widget build(BuildContext context) {
    ...
    return notJobJedge || widget.notJobJedge
        ? const Scaffold(
            //アップバー
            appBar: TitleAppBar(
              title: "求人が存在しません",
            ...
            body: Center(child: Text("対象求人ページは削除されました。")),
          )
        : Scaffold(
            //アップバー
            appBar: DetailAppbar(
              ...
              id: jobDetailList["id"],
              callback: () => changeNotJobJedge(true),
            ),
            //body
                                                                      ...
                                                                      return Center(
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            shape:
                                                                                RoundedRectangleBorder(
                                                                              borderRadius: BorderRadius.circular(10), // ここで角の丸みを調整します
                                                                            ),
                                                                            title:
                                                                                const Text('未入力の項目があります'),
                                                                            content:
                                                                                const Text('タイトルと詳細を入力してください'),
                                                                            actions: <Widget>[
                                                                              TextButton(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            title:
                                                                                const Text('投稿確認'),
                                                                            content:
                                                                                const Text('この内容で投稿しますか？'),
                                                                            actions: <Widget>[
                                                                              TextButton(
                                                                                child: const Text('投稿'),
                                                                                onPressed: () {
                                                                                  reviewWrite(jobDetailList["id"], store);
                                                                                  Navigator.of(context).pop();
                                                                                  Navigator.of(context).pop();
                                                                                  showDialog(
                                                                                    context: context,
                                                                ...
                                                                onPressed: () {
                                                                  ...
                                                                  final TextEditingController
                                                                      ...
                                                                      TextEditingController(
                                                                          text: jobDetailList["review"][index]
                                                                              [
                                                                              "title"]);
                                                                  final TextEditingController
                                                                      detailController =
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return SimpleDialog(
                                                                        ...
                                                                        shape:
                                                                            RoundedRectangleBorder(
                                                                          borderRadius:
                                                                              BorderRadius.circular(10), // ここで角の丸みを調整します
                                                                        ),
                                                                        // title: const Text(
                                                                        //   "通報",
                                                                        //   style: TextStyle(
                                                                        ...
                                                                        // ),
                                                                        children: [
                                                                          if (jobDetailList["review"][index]["user"]["id"] ==
                                                                              store.myID)
                                                                            Center(
                                                                              child: SizedBox(
                                                                                width: width / 10 * 6,
                                                                          ...
                                                                          if (jobDetailList["review"][index]["user"]["id"] ==
                                                                            ...
                                                                            SimpleDialogOption(
                                                                              onPressed: () => {
                                                                                reviewDelite(jobDetailList["id"], store),
                                                                                Navigator.pop(context),
                                                                                showDialog(
                                                                                  context: context,
                                                                                  builder: (BuildContext context) {
